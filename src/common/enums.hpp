    ...
    enum AgroEvent : u32 {
        AGRO_LAYOUT_NONE    = LAYOUT_NONE,
        AGRO_LAYOUT_MARGIN  = LAYOUT_MARGIN,
        AGRO_LAYOUT_BORDER  = LAYOUT_BORDER,
        AGRO_LAYOUT_PADDING = LAYOUT_PADDING,
        AGRO_LAYOUT_FONT    = LAYOUT_FONT,
        AGRO_LAYOUT_STYLE   = LAYOUT_STYLE,
        AGRO_LAYOUT_CHILD   = LAYOUT_CHILD,
        AGRO_LAYOUT_SCALE   = LAYOUT_SCALE,
        AGRO_USER_CALLBACK  = 0b01000000,
    };
#endif
