    ...
    class CustomWidget : public Widget {
        public:
            ...
            void draw(DrawingContext *dc, Rect rect) {
                ...
                dc->drawLine(Point(rect.x, rect.y + 110), Point(rect.x + rect.w, rect.y + 160), 5, Color(1, 1));
                for (int i = 0; i < rect.w; i += 10) {
                    dc->drawPoint(Point(rect.x + i, rect.y + 180), Color(0.2, 0.2, 0.2));
                    dc->drawPoint(Point(rect.x + i, rect.y + 190), Color(0.7, 0.5, 0.2));
                }
                dc->drawImage(rect.x, rect.y + 200, m_texture);
                dc->drawImage(rect.x + 60, rect.y + 200, m_texture, Color(1, 0));
                dc->drawImage(rect.x + 120, rect.y + 200, m_texture, Color(0, 1));
                dc->drawImage(rect.x + 180, rect.y + 200, m_texture, Color(0, 0, 1));
            }
