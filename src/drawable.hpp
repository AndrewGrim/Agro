...
class Drawable {
    public:
        ...
        /// draw itself in its entirety every time unless it is a Scrollable or similar.
        ...
        /// A layout should guarantee that a Drawable gets its requested size ??? TODO double check
