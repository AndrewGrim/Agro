    ...
    struct DrawingContext {
        ...
        void fillTextMultiline(Font *font, std::string text, Point point, Color color = COLOR_BLACK, int line_spacing = 5);
        ...
        void fillTextMultilineAligned(Font *font, std::string text, HorizontalAlignment h_align, VerticalAlignment v_align, Rect rect, int padding, Color color = COLOR_BLACK, int line_spacing = 5);
