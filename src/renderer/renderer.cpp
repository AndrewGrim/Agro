...
// TODO this works, buts its very low quality
void Renderer::drawLine(Point from, Point to, float line_width, Color color) {
    check();
    ...
    vertices[index++] = {
        ...
        0.0,
        (float)Renderer::Sampler::Color,
        {from.x, from.y, to.x - from.x, line_width}
    };
    // BOTTOM LEFT
    vertices[index++] = {
        {0.0,  0.0},
    ...
    vertices[index++] = {
        ...
        0.0,
        (float)Renderer::Sampler::Color,
        {from.x, to.y, to.x - from.x, line_width}
    };
    // TOP RIGHT
    vertices[index++] = {
        {1.0,  1.0},
